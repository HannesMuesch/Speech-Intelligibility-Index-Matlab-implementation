...
%
% Note: The remaining sections of the standard, which provide means to calculate input parameters required by
% the "core" SII procedure of Section 4, are implemented in seperate scripts:
% Section 5.1 in script Input_5p1.m "method based on the direct measurement/ estimation of noise and speech spectrum levels at the listener's position"
% Section 5.2 in script Input_5p2.m "method based on MTFI/CSNSL measurements at the listener's position"
% Section 5.3 in script Input_5p3.m "method based on MTFI/CSNSL measurements at the eardrum of the listener"
%
%
...
if ~((tst==1)|(tst==2)|(tst==3)|(tst==4)|(tst==5)|(tst==6)|(tst==7)|(tst==8)),
	error('Band Importance function must be integer between 1 and 8');
end;
	
BIArr= [0.0083	0		0.0365	0.0168	0		0.0114	0       0.0082
